#include "UI_MVVM_Example/Actor/Public/UI_MVVM_ExampleCharacter.h"
...
AUI_MVVM_ExampleCharacter::AUI_MVVM_ExampleCharacter()
{
...
void AUI_MVVM_ExampleCharacter::NotifyControllerChanged()
{
...
void AUI_MVVM_ExampleCharacter::SetupPlayerInputComponent(
	UInputComponent* PlayerInputComponent)
{
		...
		Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered,
		                                   this,
		                                   &AUI_MVVM_ExampleCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered,
		                                   this,
		                                   &AUI_MVVM_ExampleCharacter::Look);
	}
	else
	{
		UE_LOG(
...
void AUI_MVVM_ExampleCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUI_MVVM_ExampleCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
